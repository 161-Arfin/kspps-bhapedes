...
import { ChevronLeft, ChevronRight, Calendar, ArrowRight, Building2, HeartHandshake, Users, Newspaper } from "lucide-react";
...
const Counter: React.FC<CounterProps> = ({ value, duration = 2000, noFormat = false }) => {
...
export default function HomeView() {
  ...
  const nextSlide = () => setCurrentSlide((prev) => (prev + 1) % dataHero.length);
  const prevSlide = () => setCurrentSlide((prev) => (prev - 1 + dataHero.length) % dataHero.length);
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 md:gap-24 items-center">
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#1A1A1A] mt-4 leading-tight">
              ...
              Berbasis Keanggotaan dan Kebersamaan
            </h2>

            <p className="text-gray-600 mt-4 leading-relaxed">
              KSPPS Bhakti Pemuda Desa hadir sebagai mitra terpercaya dalam
              pemberdayaan ekonomi umat melalui layanan simpanan,
              pembiayaan usaha, serta pengelolaan dana sosial
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-2">
                ...
                untuk mendukung pemberdayaan ekonomi masyarakat.
              </p>
            ...
            <div className="lg:col-span-2">
              {isLoadingNews ? (
                ...
                <div className="flex flex-col items-center justify-center py-20 bg-white rounded-lg border border-gray-100 text-center px-6">
                  ...
                  <p className="text-gray-500 font-medium">Belum ada berita terbaru</p>
                  <p className="text-gray-400 text-sm mt-1">Silakan kembali lagi nanti untuk informasi terbaru.</p>
                </div>
              )}
            </div>
