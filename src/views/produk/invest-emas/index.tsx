      ...
      <section className="bg-[#2E7D32] py-12 text-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="mt-4 max-w-2xl text-green-100 leading-relaxed">
            Solusi investasi yang aman dan bernilai stabil melalui
            kepemilikan emas dengan sistem syariah yang transparan
            dan terpercaya.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              ...
              investasi yang telah dikenal luas karena nilainya
              yang cenderung stabil dan mampu menjaga nilai
              kekayaan dalam jangka panjang.
            </p>

            <p className="text-gray-600 leading-relaxed mb-4">
              Melalui layanan investasi emas di KSPPS Bhapedes,
              anggota dapat memiliki emas secara bertahap
              melalui sistem tabungan atau cicilan yang
              dikelola berdasarkan prinsip syariah.
            </p>

            <p className="text-gray-600 leading-relaxed">
              Program ini membantu anggota merencanakan
              investasi masa depan dengan cara yang aman,
              mudah, dan sesuai dengan nilai-nilai Islam.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-100 shadow-sm text-center">
              ...
              <p className="text-gray-500 text-sm">
                Emas dikenal sebagai aset yang relatif stabil
                dan mampu menjaga nilai kekayaan.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-100 shadow-sm text-center">
              ...
              <p className="text-gray-500 text-sm">
                Dikelola sesuai prinsip syariah dan diawasi
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-100 shadow-sm text-center">
              ...
              <p className="text-gray-500 text-sm">
                Anggota dapat memiliki emas secara bertahap
                melalui setoran atau cicilan ringan.
              </p>
            </div>
