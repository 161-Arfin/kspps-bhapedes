        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h2 className="text-3xl font-bold text-[#1A1A1A] mb-4">
              Apa itu <span className="text-[#f08519]">Simpanan Pelajar?</span>
            </h2>
      ...
      <section className="py-16 bg-[#F8FAF8]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-6">
            ...
            <div className="w-16 h-1 bg-[#f08519] mx-auto mt-2 rounded" />
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-100 shadow-sm text-center">
              <Users className="mx-auto text-[#194e9e] mb-4" size={32} />
